...
public interface IUserService {
   ...
   *
   * Accepts an {@link UpdateUserRequest} DTO containing the updated user fields.
   ...
   *
   * @param status the {@link UserStatus} to filter by (null to ignore filtering)
   ...
   *
   * Accepts an {@link AssignRolesRequest} DTO containing the user ID and role IDs
   * to assign.
