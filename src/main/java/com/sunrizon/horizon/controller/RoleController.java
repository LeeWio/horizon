...
public class RoleController {
  ...
  @Operation(summary = "创建角色", description = "创建新的系统角色。需要管理员权限。", security = @SecurityRequirement(name = "Bearer Authentication"))
  @ApiResponses({
  ...
  public ResultResponse<RoleVO> createRole(
      @Parameter(description = "角色创建信息", required = true) @RequestBody CreateRoleRequest request) {
    return roleService.createRole(request);
  }

  @Operation(summary = "获取角色信息", description = "根据角色ID获取角色详细信息。需要认证。", security = @SecurityRequirement(name = "Bearer Authentication"))
  @ApiResponses({
  ...
  @Operation(summary = "删除角色", description = "根据角色ID删除角色。需要管理员权限。", security = @SecurityRequirement(name = "Bearer Authentication"))
  @ApiResponses({
  ...
  @Operation(summary = "分配角色给用户", description = "将一个或多个角色分配给指定用户。需要管理员权限。", security = @SecurityRequirement(name = "Bearer Authentication"))
  @ApiResponses({
  ...
  public ResultResponse<String> assignRoles(
      @Parameter(description = "角色分配信息", required = true) @Valid @RequestBody AssignRolesRequest request) {
